/**
 * source: https://github.com/remix-run/react-router/issues/7634#issuecomment-1025113528
 * blog: https://shallowdepth.online/posts/2022/04/why-usenavigate-hook-in-react-router-v6-triggers-waste-re-renders-and-how-to-solve-it/
 * issues with react-router-dom v6 useNavigate and useLocation hooks
 * */
...
*/
const RouterUtils = ({ children }: { children: JSX.Element }) => {
...
*/
export const useQueryParamNoUpdates = (name: never) => {
